...
class DateTimePicker {
   ...
   *
   * @param date {Date.ts} The date to draw the calendar for.
  ...
  /**
   * @returns {Date.ts} Return the current value of the time picker.
   */
  getDate() {
   ...
   *
   * @param {Date.ts} newDate The new date.
   * @returns {DateTimePicker} This DateTimePicker.
   */
  setDate(newDate) {
    this.date = newDate;
   ...
   *
   * @param date {Date.ts} The date to build the calendar week based on.
